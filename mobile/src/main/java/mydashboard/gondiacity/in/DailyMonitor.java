...
/*
todo rename this as possible work list. instead of showing a list show aa cardview with sub group broken listview 29 octomber 16
banega kya?????????
...
public class DailyMonitor extends Activity implements OnItemClickListener,OnClickListener,TextWatcher
{
	...
	public void onClick(View arg0) {
		...
		switch(arg0.getId())
		{
			...
			ActionItem indian=new ActionItem(1,"10 Min\t\t",getResources().getDrawable(R.drawable.indian_food_icon));
			ActionItem american=new ActionItem(2,"15 Min\t\t",getResources().getDrawable(R.drawable.burger_icon));
			ActionItem italian=new ActionItem(3,"30 Min\t\t",getResources().getDrawable(R.drawable.pizza_icon));
			ActionItem chinese=new ActionItem(4,"1 Hour\t\t",getResources().getDrawable(R.drawable.chinese_icon));
			ActionItem add_custom=new ActionItem(5,"Custom Time\t\t",getResources().getDrawable(R.drawable.add_custom_icon));
	...
	private DragListener mDragListener =	new DragListener() {
			...
			Toast.makeText(getApplicationContext(), "Drag and Drop To add", Toast.LENGTH_SHORT).show();
